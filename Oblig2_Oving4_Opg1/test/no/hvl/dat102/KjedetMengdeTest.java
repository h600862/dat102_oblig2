...
class KjedetMengdeTest {
	...
	private MengdeADT<Integer> testM = new KjedetMengde();
	private KjedetMengde<Integer> testM2 = new KjedetMengde();
	...
	public void unionDisjunkt() {
		setupDisjunkt();
		MengdeADT<Integer> testUnion = new KjedetMengde();
	...
	public void snittDisjunkt() {
		setupDisjunkt();
		MengdeADT<Integer> testSnitt = new KjedetMengde();
	...
	public void differensLike() {
		setupLike();
		MengdeADT<Integer> testDiff = new KjedetMengde();
